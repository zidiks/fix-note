...
const translationsRu = {
  ...
  welcomeTitle: 'FixNote',
  welcomeSubtitle: 'Голосовые заметки с AI',
  ...
  // Notes list
  noNotes: 'Нет заметок',
  noNotesDesc: 'Удерживайте кнопку микрофона, чтобы записать голосовую заметку',
  ...
  syncAllNotes: 'Синхронизировать все',
  syncingAll: 'Синхронизация...',
  syncedCount: 'Синхронизировано: {count}',
  failedCount: 'Ошибок: {count}',
  allUpToDate: 'Всё синхронизировано',
  never: 'Никогда',
  justNow: 'Только что',
  ...
  syncSuccess: 'Синхронизировано с Notion',
  syncSkipped: 'Уже синхронизировано',
...
const translationsEn: typeof translationsRu = {
  ...
  welcomeTitle: 'FixNote',
  welcomeSubtitle: 'Voice notes with AI',
  ...
  // Notes list
  noNotes: 'No Notes',
  noNotesDesc: 'Hold the microphone button to record a voice note',
...
export const translations = { ru: translationsRu, en: translationsEn } as const;
